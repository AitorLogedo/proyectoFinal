...
CREATE TABLE `pregunta` (
  ...
  KEY `fk_pregunta_usuario1_idx` (`cliente_id`),
  KEY `fk_pregunta_producto1_idx` (`producto_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='preguntas sobre un producto';
