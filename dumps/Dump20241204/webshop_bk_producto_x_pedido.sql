...
CREATE TABLE `producto_x_pedido` (
  ...
  KEY `fk_producto_x_pedido_producto1_idx` (`producto_id`),
  KEY `fk_producto_x_pedido_pedido1_idx` (`pedido_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='productos de un pedido';
